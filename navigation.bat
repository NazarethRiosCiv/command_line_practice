...
:: The command line is a text interface for your computer. It's a program that takes in commands 
:: and passes them on to the computer's operating system to run.

:: From the command line, you can navigate through files and folders on your computer, just like 
:: using the GUI tools like File Explorer on Windows or Finder on MacOS. 
...
:: In the terminal, the first thing you see is >. This is called a shell prompt. It appears when 
:: the terminal is ready to accept a command.
...
:: The tab key can be used to autocomplete your command. When you are typing the name of an 
:: existing file or directory, you can use tab to finish the rest of the name.
